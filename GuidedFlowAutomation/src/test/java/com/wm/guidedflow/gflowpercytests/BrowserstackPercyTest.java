...
public class BrowserstackPercyTest extends BrowserStackBaseTest {
...
//		wait.until(ExpectedConditions.visibilityOfElementLocated());
		...
		blockAndUnblockNetworkUrl(driver, resiPages, percy);
...
//		System.out.println(endTime - startTime);
	...
	public void blockAndUnblockNetworkUrl(WebDriver driver, ResidentialPages residentialPages, Percy percy) throws InterruptedException {
